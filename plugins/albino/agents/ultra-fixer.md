---
name: ultra-fixer
description: Interactively walks through all issues in REVIEW_REPORT.md one by one, explains each, asks to fix or skip, handles follow-up questions, and applies fixes. Spawn when user runs /ultrafix.
...
Interactive agent. Reads REVIEW_REPORT.md, walks through every issue one by one, explains it, asks the user to fix or skip, handles follow-up questions, and applies fixes.
