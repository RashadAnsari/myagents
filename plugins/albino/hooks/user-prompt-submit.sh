...
MEMORY READ PATTERN: For every non-trivial task you MUST call project.search + user.search with specific terms from this task: file names, function names, domain concepts, error messages.
